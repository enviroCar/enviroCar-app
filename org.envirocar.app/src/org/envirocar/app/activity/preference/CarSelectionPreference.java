...
//                    tmpCar.setFuelType(carFuelType);
//                    tmpCar.setManufacturer(carManufacturer);
//                    tmpCar.setModel(carModel);
//                    tmpCar.setConstructionYear(Integer.parseInt(carConstructionYear));
//                    tmpCar.setEngineDisplacement(Integer.parseInt(carEngineDisplacement));
//
//                    try {
//                        String sensorId = mDAOProvider.getSensorDAO().createCar(tmpCar);
//
...
//                            @Override
//                            public void run() {
//                                Toast.makeText(getContext(), "Server Error: " + e1.getMessage(),
