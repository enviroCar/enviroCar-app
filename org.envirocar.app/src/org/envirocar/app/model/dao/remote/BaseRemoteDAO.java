...
//    private HttpResponse executeHttpRequest(HttpUriRequest request) throws NotConnectedException {
    ...
    //
    //
    //    protected Observable<JSONObject> readRemoteResourceStream(String remoteRestResource,
    // boolean
    //            complete) {
    ...
    //                try {
    //                    // If the complete flag is false, then only return the first 100
    // results as
    //                    // JSONObject.
    //                    if (!complete) {
    ...
    //                    }
    //
    //                    // When there are more than 100 entries, then make a request for every
    // page.
    //                    if (count > 1) {
    //                        for (int i = 1; i <= count; i++) {
    ...
    //     * @throws IOException
    //     */
    //    protected HttpEntity preparePayload(CharSequence content) throws
