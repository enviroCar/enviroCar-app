...
//        res.measurements = new ArrayList<>(getMeasurements());
//        res.car = car;
//        res.consumptionAlgorithm = consumptionAlgorithm;
//        res.consumptionPerHour = consumptionPerHour;
//        res.status = status;
//        res.lazyLoadingMeasurements = lazyLoadingMeasurements;
...
//                distance = distance + Util.getDistance(measurements.get(i).getLatitude(),
//                        measurements.get(i).getLongitude(), measurements.get(i + 1).getLatitude()
...
//                    co2Average = co2Average + consumptionAlgorithm.calculateCO2FromConsumption
...
//                try {
//                    consumptionPerHour = consumptionPerHour + consumptionAlgorithm
//                            .calculateConsumption(measurements.get(i));
//                    consideredCount++;
//                } catch (FuelConsumptionException e) {
...
//                e.printStackTrace();
//            }
//        return consumptionPerHour * getDurationInMillis() / (1000 * 60 * 60) / getLengthOfTrack()
//                * 100;
//    }
//
...
//        JSONObject sensorProperties = trackProperties.getJSONObject("sensor").getJSONObject
//                ("properties");
//
...
//        logger.info("Parsing measurements of track " + t.getRemoteID() + ". Count: " + features
//                .length());
