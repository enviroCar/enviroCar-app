...
public enum ConsumptionFormula {
	...
	MILESPERUSGALLON("mpg(us)"), MILESPERIMPERIALGALLON("mpg(imp)"), LITERSPER100KILOMETERS("L/100 km"), KILOMETERSPERLITER("km/L"), USGALLONSPER100MILES("g(us)/100mi"), IMPERIALGALLONSPER100MILES("g(imp)/100mi"), UNKNOWNFORMULA("unknown");
