...
public class ObdContent1Fragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        Drawable image = getActivity().getDrawable(R.drawable.findobddesgin);
        imageView.setImageDrawable(image);
        obdHelpText.setText(getString(R.string.obd_help_content));
        return contentView;
    }
}
