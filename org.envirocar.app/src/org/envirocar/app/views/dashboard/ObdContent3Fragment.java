...
public class ObdContent3Fragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        Drawable image = getActivity().getDrawable(R.drawable.connectwithapp);
        imageView.setImageDrawable(image);
        obdHelpHead.setText("Connect");
        obdHelpText.setText(getText(R.string.obd_help_content3));
        return contentView;
    }
}
