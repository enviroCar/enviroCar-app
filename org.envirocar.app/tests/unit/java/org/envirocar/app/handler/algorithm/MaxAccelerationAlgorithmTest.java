...
public class MaxAccelerationAlgorithmTest {

    private MaxAccelerationAlgorithm algorithm;

    @Before
    public void setup(){
        algorithm = new MaxAccelerationAlgorithm();
    }
    ...
    public void test(){
        ...
        Assert.assertEquals(45., algorithm.calculate(pkes).doubleValue(),0.0001);
    }
